...
%changelog
* Thu Mar 08 2018 RDO <dev@lists.rdoproject.org> 5.1.4-1
- Update to 5.1.4

* Wed Nov 22 2017 RDO <dev@lists.rdoproject.org> 5.1.3-1
- Update to 5.1.3

* Thu Apr 27 2017 rdo-trunk <javier.pena@redhat.com> 5.1.2-1
- Update to 5.1.2

* Thu Jan 05 2017 Jon Schlueter <jschluet@redhat.com> 5.1.1-1
- Update to 5.1.1

* Fri Sep 16 2016 Haikel Guemar <hguemar@fedoraproject.org> 5.1.0-1
- Update to 5.1.0
